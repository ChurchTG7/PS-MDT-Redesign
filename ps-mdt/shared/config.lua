...
-- NEW UI TOGGLE
-- ============================================
-- Set to true to use the new React-based redesigned UI
-- Set to false to use the original ps-mdt UI
-- The new UI is located in the 'newui' folder
Config.UseNewUI = true

-- Enable debug mode for the new UI (shows console logs)
Config.Debug = false

Config.OnlyShowOnDuty = true

-- ============================================
-- MUGSHOT WEBHOOK SETTINGS
-- ============================================
-- Choose how mugshot images are stored:
-- 'fivemerr' = Use Fivemerr API (RECOMMENDED - images don't expire)
-- 'discord' = Only send to Discord webhook (NOT RECOMMENDED - images expire)
-- 'database' = Store mugshot data in database only (no external images)
-- 'hybrid' = Discord webhook AND database storage
Config.MugShotWebhookMode = 'fivemerr' -- Options: 'fivemerr', 'discord', 'database', 'hybrid'

-- RECOMMENDED: Fivemerr Images (DOES NOT EXPIRE)
-- Documents: https://docs.fivemerr.com/integrations/mdt-scripts/ps-mdt
Config.FivemerrMugShot = 'https://api.fivemerr.com/v1/media/images'
Config.FivemerrApiKey = 'YOUR API KEY HERE'

-- Discord webhook for mugshot images (NOT RECOMMENDED - images expire)
...
-- ============================================
-- CLOCKIN WEBHOOK SETTINGS
-- ============================================
-- Choose how clock-in/clock-out events are logged:
-- 'discord' = Only send to Discord webhook
-- 'database' = Only log to database (mdt_clocking table)
-- 'hybrid' = Both Discord webhook AND database
Config.ClockinWebhookMode = 'hybrid' -- Options: 'discord', 'database', 'hybrid'

-- Clock-in notifications for duty. Add your Discord webhook URL here.
-- Command /mdtleaderboard, will display top players per clock-in hours.
Config.ClockinWebhook = ''

-- Incident and Incident editing. Add your Discord webhook URL here.
-- Incident Author, Title, and Report will display in webhook post.
Config.IncidentWebhook = ''
